...
<form id="loginFormPopup" class="woocommerce-form woocommerce-form-login login p-4 p-md-6 test345" method="post" >
    ...
    <div class="form-group mb-4">
        <div class="js-form-message js-focus-state">
            <label class="form-label" for="username"><?php esc_html_e( 'Email', 'bookworm' ); ?> *</label>
    ...
    <div class="d-flex justify-content-between mb-5 align-items-center">
        ...
        <a class="lost_password js-animation-link text-dark font-size-2 t-d-u link-muted font-weight-medium" href="<?php echo home_url(); ?>/my-account/lost-password/">
