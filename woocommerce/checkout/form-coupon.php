...
<form class="checkout_coupon woocommerce-form-coupon p-4 bg-white border mb-4" method="post" style="display:none">
    ...
    <div class="row d-flex">
        ...
        <p class="col-md-3">
            <button type="submit" class="button border-0 height-4 btn btn-dark rounded-0<?php echo esc_attr( wc_wp_theme_get_element_class_name( 'button' ) ? ' ' . wc_wp_theme_get_element_class_name( 'button' ) : '' ); ?>" name="apply_coupon" value="<?php esc_attr_e( 'Apply coupon', 'bookworm' ); ?>"><?php esc_html_e( 'Apply coupon', 'bookworm' ); ?></button>
        </p>
    </div>
</form>
