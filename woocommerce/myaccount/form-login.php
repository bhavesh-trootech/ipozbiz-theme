...
<div class="container pt-5 form-login test78" id="customer_login">
	<div class="row">
		<div class="col-md-6 mx-md-auto">
			<div class="card border-0 box-shadow">
				<div class="card-body">
					...
					<form class="woocommerce-form woocommerce-form-login login accountLogin" method="post">

						<?php do_action( 'woocommerce_login_form_start' ); ?>

						<div class="woocommerce-form-row woocommerce-form-row--wide form-group">
							<label for="username"><?php esc_html_e( 'Email', 'bookworm' ); ?><span class="text-danger">*</span></label>
		...
		<?php if ( 'yes' === get_option( 'woocommerce_enable_myaccount_registration' ) ) : ?>
			<div class="col-md-6 pt-4 mt-3 mt-md-0">
				...
				<form method="post" id="registerFormAccount" class="woocommerce-form woocommerce-form-register register" <?php do_action( 'woocommerce_register_form_tag' ); ?> >
					...
					<div class="woocommerce-form-row woocommerce-form-row--wide form-group">
						<label for="reg_email"><?php esc_html_e( 'Email', 'bookworm' ); ?><span class="text-danger">*</span></label>
						...
						<span class="errorForm errorEmail" id="email-error-reg"></span>
					</div>
					<!-- <p class="font-size-sm text-muted"><?php //esc_html_e( 'Enter valid email address.', 'bookworm' ); ?></p> -->
					...
					<?php if ( 'no' === get_option( 'woocommerce_registration_generate_password' ) ) : ?>
						...
						<div class="woocommerce-form-row woocommerce-form-row--wide form-group">
							...
							<div class="password-toggle">
								...
								<span class="errorForm errorPass" id="password-error-reg"></span>
							</div>
						</div>
