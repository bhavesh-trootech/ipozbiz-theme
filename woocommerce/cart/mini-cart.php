...
<?php if ( ! WC()->cart->is_empty() ) : ?>
    ...
    <div class="woocommerce-mini-cart <?php echo esc_attr( $args['list_class'] ); ?>">
        ...
        <div class="woocommerce-mini-cart__buttons">
            ...
            <a href="<?php echo esc_url( wc_get_cart_url() ); ?>" class="btn btn-block rounded-0 btn-outline-dark viewCartBtnMini">
                <?php esc_html_e( 'View Cart', 'bookworm' ); ?>
            </a>
            <a href="<?php echo esc_url( wc_get_checkout_url() ); ?>" class="btn btn-block rounded-0 btn-dark viewCheckoutBtnMini">
