...
<div class="d-flex flex-column align-items-center pt-lg-7 pb-lg-4 pb-lg-6">
    ...
    if ( wc_get_page_id( 'shop' ) > 0 ) : ?>
        <p class="return-to-shop d-flex align-items-center flex-column m-0">
            <a class="button wc-backward btn btn-dark rounded-0 btn-wide height-60 width-250 font-weight-medium d-flex align-items-center justify-content-center<?php echo esc_attr( wc_wp_theme_get_element_class_name( 'button' ) ? ' ' . wc_wp_theme_get_element_class_name( 'button' ) : '' ); ?>" href="<?php echo esc_url( apply_filters( 'woocommerce_return_to_shop_redirect', wc_get_page_permalink( 'shop' ) ) ); ?>">
